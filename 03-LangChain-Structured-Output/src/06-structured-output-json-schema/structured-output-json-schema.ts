...
const reviewJSONSchema = {
    "title": "Review of a product sold",
    "description": "A review of the product, thats given by the user",
    "type": "object",
    "properties": {
        "key_themes": {
            "type": "array",
            ...
            "description": "Write down all the key themes discussed in the review in an array"
        },
        "summary": {
            "type": "string",
...
const structuredModel = model.withStructuredOutput(reviewJSONSchema, {
    method: "jsonSchema"
});
